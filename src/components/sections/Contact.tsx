          ...
          >
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Mail, title: 'Email', content: 'info@saisystems.com', href: 'mailto:info@saisystems.com' },
                { icon: MapPin, title: 'Address', content: '123 Business Street, Tech City, TC 12345', href: '#' }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
